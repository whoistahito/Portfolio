    ...
    return (
      <main className="relative w-full min-h-screen bg-[#D3CCC3] font-[Antonio] text-black overflow-x-hidden">
        ...
        <div
          ...
          style={{ minHeight: 2474 }}
        >
          {/* News 1 */}
          <div className="absolute left-[74px] top-[225px] w-[600px]">
            <h2 className="font-normal text-[40px] leading-[150%] mb-8">
              AUSSTELLUNG
              <br />
              »VOM WERDEN UND WACHSEN«
            </h2>
            <p
              className="font-thin text-[28px] leading-[160%] text-justify mb-8"
              style={{ height: 300 }}
            >
              Die Ausstellung zeigt meinen künstlerischen Entwicklungs-prozess
            ...
            <div className="absolute left-[0px] top-[490px] w-[600px]">
              <p
                className="font-normal text-[24px] leading-[150%] text-justify"
                style={{ height: 161 }}
              >
                Markt 15
                <br />
            ...
            <div className="absolute left-[260px] top-[503px] w-[350px] h-[62px] flex items-center justify-center border-2 border-[#854686] rounded-[36px]">
              <span className="font-semibold text-[32px] tracking-[0.1em]">
                04.03. – 14.04.2026
              </span>
            </div>
          </div>
          ...
          <img
            src={NachtderKunst}
            alt="Nacht der Kunst"
            className="absolute left-[72px] top-[970px] w-[837px] h-[485px] rounded-[8px]"
          />

          {/* News 2 */}
          <div className="absolute left-[72px] top-[1470px] right-[531px]">
            <h2 className="font-normal text-[40px] leading-[150%] mb-2">
              NACHT DER KUNST- UND KULTURORTE <br />
            </h2>
          </div>
          <div className="absolute left-[72px] top-[1555px] right-[531px]">
            <p
              className="font-thin text-[24px] leading-[150%] text-justify"
              style={{ height: 161 }}
            >
          ...
          <div className="absolute left-[980px] top-[1355px] w-[396px]">
            <h3 className="font-normal text-[39px] leading-[150%] mb-2">
  ...
  return (
    <div className="bg-[#d4cdc4] grid justify-items-center [align-items:start] w-screen min-h-screen pt-5">
      ...
      <div className="translate-y-[90px] pb-8 px-4 gap-8">
        <h2 className="font-normal text-[18px] leading-[150%] mb-4">
      ...
      <div className="w-full max-w-[430px] mx-auto pt-12 pb-8 px-4 flex flex-col gap-8">
        ...
        <div className="flex gap-4">
          <div className="flex-1">
            ...
            <p className="translate-y-[35px] font-normal text-[14px] leading-[150%] text-justify">
              Markt 15
              <br />
              24321 Lütjenburg
            </p>
            <div className="translate-y-[-8px] translate-x-[215px] w-[180px] h-[32px] flex items-center justify-center border-2 border-[#854686] rounded-[18px] mt-2">
              <span className="font-semibold text-[16px] tracking-[0.1em]">
                04.03. – 14.04.2026
              </span>
            </div>
          </div>
        ...
        {/* Divider Line */}
        <div
          className="translate-y-[0px] w-full border-t border-[#636263]"
          style={{}}
        />
        ...
        <div className="flex flex-row gap-4 items-start w-full">
          ...
          <div className="flex-1 flex flex-col gap-2">
            <img
              src={NachtderKunst}
              alt="Nacht der Kunst"
              className="w-full h-auto rounded-[4px] object-cover aspect-[1.7]"
            />
            <h2 className="font-normal text-[18px] leading-[120%] mt-2">
              NACHT DER KUNST- UND KULTURORTE
            </h2>
            <p className="font-thin text-[14px] leading-[140%] text-justify">
              Am Samstag, den 28. Februar 2026, öffne ich mein Zuhause für die
              Öffentlichkeit von 18 bis 22 Uhr im Rahmen der Schwentinentaler
              Nacht der Kunst- und Kulturorte.
            </p>
            <p className="font-normal text-[14px] leading-[140%] mt-1">
              Elsa-Brandström-Straße 7<br />
              24223 Schwentinental
            </p>
            <div className="mt-2 w-full max-w-[140px] h-[32px] flex items-center justify-center border-2 border-[#854686] rounded-[18px]">
              <span className="font-semibold text-[14px] tracking-[0.1em]">
                28.02.2026
              </span>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col gap-2">
            <img
              src={Calendar2026}
              alt="Calendar 2026"
              className="w-full h-auto bg-[#E99348] rounded-[4px] object-cover aspect-square"
            />
            <h3 className="font-normal text-[18px] leading-[120%] mt-2">
              KUNSTKALENDER 2026 ERHÄLTLICH
            </h3>
            <p className="font-thin text-[14px] leading-[140%] text-justify">
              Mein Kunstkalender 2026 ist ab sofort an verschiedenen
            ...
            <a
              href="/updates/calendar-2026"
              className="text-[#854686] underline cursor-pointer text-xs mt-2 inline-block"
            >
              Mehr Infos
            </a>
          </div>
